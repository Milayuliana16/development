                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card border-0 shadow-sm rounded">
                                            <div class="card-body">
                                                    <a href="{{ route('mahasiswas.create') }}" class="btn btn-md btn-success mb-3">Tambah Data</a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($mhs as $d)
                                                            <tr>
                                                                ...
                                                                <td>{{ $d->nama }}</td>
                                                                <td>{{ $d->nim }}</td>
                                                                <td>{{ $d->prodi->namaprodi }}</td>
                                                                <td>
                                                                    <a href="{{ route('mahasiswas.edit', ['mahasiswa' => $d->id]) }}" class="btn btn-sm btn-warning">Edit</a>
                                                                    <form action="{{ route('mahasiswas.destroy', ['mahasiswa' => $d->id]) }}" method="POST" style="display: inline;">
                                                                        @csrf
                                                                        @method('DELETE')
